...
export default function OrderSuccess({ orderId, total, address, items }: OrderSuccessProps) {
  return (
    <div className="text-center py-12">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        <Link href="/" className="bg-black text-white px-6 py-3 rounded-xl hover:bg-gray-800 transition">
          Back to catalog
        </Link>
        <Link href="/profile" className="border border-black px-6 py-3 rounded-xl hover:bg-gray-50 transition">
          My orders
        </Link>
      </div>
    </div>
